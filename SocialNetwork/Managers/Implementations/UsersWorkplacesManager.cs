...
namespace Managers.Implementations
{
    internal class UsersWorkplacesManager : ManagerBase, IUsersWorkplacesManager
    {
        ...
        public async Task<IEnumerable<UserWorkplace>> GetUsersWorkplacesByUserId(string userId)
        {
        ...
        public async Task<UserWorkplace> GetUserWorkplaceById(string userId, int workplaceId)
        {
