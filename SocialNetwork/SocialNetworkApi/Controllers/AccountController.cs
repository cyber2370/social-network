...
namespace SocialNetworkApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            AspNetUser user = await UserManager.FindByIdAsync(User.Identity.GetUserIdIntPk());
        ...
        public async Task<IHttpActionResult> SetPassword(SetPasswordBindingModel model)
        {
            ...
            IdentityResult result = await UserManager.AddPasswordAsync(User.Identity.GetUserIdIntPk(), model.NewPassword);
        ...
        public async Task<IHttpActionResult> AddExternalLogin(AddExternalLoginBindingModel model)
        {
            ...
            IdentityResult result = await UserManager.AddLoginAsync(User.Identity.GetUserIdIntPk(),
        ...
        public async Task<IHttpActionResult> RemoveLogin(RemoveLoginBindingModel model)
        {
            ...
            {
                result = await UserManager.RemovePasswordAsync(User.Identity.GetUserIdIntPk());
            }
            else
            {
                result = await UserManager.RemoveLoginAsync(User.Identity.GetUserIdIntPk(),
